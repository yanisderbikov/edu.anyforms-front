            ...
            {step === 'email' ? (
              <>
                ...
                <p className="lead">
                  ...
                  который вы указывали при записи, — мы пришлём код для входа.
                </p>
                <form className={styles.form} onSubmit={submitEmail}>
                  ...
                  {/* 152-ФЗ: e-mail обрабатывается для исполнения договора (доступ к купленному
                      курсу), отдельное согласие не нужно — но ознакомление с политикой до отправки
                      данных обязательно, поэтому здесь уведомление, а не «согласие». */}
